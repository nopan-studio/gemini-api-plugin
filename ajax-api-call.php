            ...
            'contents' => [[
                ...
                function gemini_floater() {
                    ...
                    function insertTypingIndicator() {
                        ...
                        chatBox.append(`
                                        <div class="gemini-message" id="${typingId}">
                    ...
                    function getGeminiResponse(isContent) {
                        ...
                        $('.user-payload').val('');
                        insertChatMessage(prompt, true, isContent);
                        
                        insertTypingIndicator(); // Show typing indicator
                        ...
                        $.post(ajax_api_obj.ajax_url, {
                            ...
                            if (response.success) {
                                ...
                                $('#typing-indicator').remove(); // Remove the typing dots
                                insertChatMessage(reply, false); // Insert Gemini reply
                    ...
                    //-------------------------------------------
                    function insertChatMessage(message, isUser = true, isContent) {
                        const chatBox = $('#chat-box');
